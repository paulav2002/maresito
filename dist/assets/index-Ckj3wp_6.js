...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:mn,depthTest:!1,depthWrite:!1})}function ba(){return new rn({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Vs(),fragmentShader:`
		...
		`,blending:mn,depthTest:!1,depthWrite:!1})}function wa(){return new rn({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Vs(),fragmentShader:`
